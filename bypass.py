...
class GoldenEye(object):
    ...
    def printHeader(self):
        ...
        # Taunt!
        os.system("clear")
        print "Ataque Bypass HTTP Spam Seyzalel"
        print "Bypass created by Seyzalel"
    ...
    def fire(self):
        ...
        self.printHeader()
        print ""
        print "Bolsonaro Botnet Atacando {}".format(self.url)
    ...
    try:
        ...
        for o, a in opts:
            if o in ("-h", "--help"):
                usage()
                sys.exit()
            elif o in (".redes", "--sockets"):
                socks = int(a)
            elif o in (".bots", "--workers"):
                workers = int(a)
            elif o in ("-d", "--debug"):
                global DEBUG
                DEBUG = True
